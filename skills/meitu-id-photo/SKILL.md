...
```bash
mv "{output_dir}/{task_id_filename}" "{output_dir}/$(date +%Y-%m-%d)_{spec_name}_{color_name}.jpg"
```

命名示例：`2026-03-23_二寸_蓝底.jpg`、`2026-03-23_美国护照_白底.jpg`
