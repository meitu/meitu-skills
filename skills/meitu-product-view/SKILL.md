...
| L5 | 停止，报错并显示 error_code 和 user_hint | 连续 2 次 L4 失败 |
...
脚本不存在 →
  `mv {output_dir}/{task_id_file} {output_dir}/{date}_{product}_{angle}.png`

**命名规则**：`{date}_{product}_{angle}.png`
示例：`20260323_sneaker_front.png`、`20260323_sneaker_back.png`、`20260323_sneaker_quarter-right.png`
