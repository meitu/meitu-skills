...
- model 映射：`gummy`（Seedream 4.0）/`gummy_pro`（Seedream 4.5）/`praline_pro`（Nano Banana Pro）/`praline_lite`（Nano Banana 2，默认）/`nougat`（ChatGPT）
